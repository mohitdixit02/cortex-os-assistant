...
5. If user is asking for any specific information, then try to provide it using the retrieved messages and user knowledge. \n
...
9. Feedback from you - If any given by you in the past evaluations. Can be null if not available. \n
...
# Instructions:
1. Understand the user query, stm summary, stm preferences, and the retrieved user knowledge and messages. \n
...
# Feedback Instructions:
If response is good and aligned with user query (score more than 8 out of 10), then mark is_feedback_required as False and keep the feedback field empty or null. \n
If response is not good and not aligned with user query (score less than or equal to 8 out of 10), then mark is_feedback_required as True and provide specific feedback on what is wrong with the response and how it can be improved. \n
