...
# Feedback Instructions:
If response is good and aligned with user query (score more than 7 out of 10), then mark is_feedback_required as False and keep the feedback field empty or null. \n
If response is not good and not aligned with user query (score less than or equal to 7 out of 10), then mark is_feedback_required as True and provide specific feedback on what is wrong with the response and how it can be improved. \n
